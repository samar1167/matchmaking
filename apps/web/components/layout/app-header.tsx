        ...
        <div className="flex flex-wrap items-center justify-center gap-3 lg:justify-end">
          {token ? (
            ...
            <>
              ...
              <Link
                href="/register"
                className="inline-flex min-h-11 items-center justify-center rounded-md bg-[#901214] px-5 text-sm font-bold !text-white shadow-[0_14px_28px_rgba(144,18,20,0.14)] transition hover:bg-[#961116] hover:!text-white"
              >
                Register
              </Link>
            </>
